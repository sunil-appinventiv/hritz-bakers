  ...
  head: () => ({
    meta: [
      { title: "Hritz Baker Mart — Premium Baking Essentials & Cake Supplies" },
      {
        name: "description",
        content:
          "Shop premium cake mixes, baking tools, and decorating essentials at Hritz Baker Mart. Everything you need for perfect bakes, every time.",
      },
      { property: "og:title", content: "Hritz Baker Mart — Premium Baking Essentials" },
      {
        property: "og:description",
        content: "Cake mixes, tools and decorating supplies for home bakers and pros.",
      },
    ],
  }),
  component: Home,
